...
export class ApplicationComponent implements OnInit {
  ...
  assessmentList = [];
  applicationToDelete = '';
/**Alterado para somente formativa */
  types = [  
    { value: 'summative', description: 'Formativa' }
  ];
/**Alterado para somente ranking */
  methods = [
    { value: 'ranking', description: 'Ranking' }   
  ];
/**Alterado de forma fictícia para estratégias do Educational*/
  strategies = [
    { value: 'self_teacher', description: 'Autoavaliação e do Professor'}
  ];
  ...
  addApplication(name: string, teamId: string, assessmentId: string, strategy: string) {
    this.spinner.show();
    let method = 'ranking';
    let  type = 'summative';
