...
export class MemberComponent implements OnInit {
  ...
  userToDelete = '';
/**Alterado para mostrar somente Professor e Estudante */
  userProfiles = [
    { value: 'organizationManager', description: 'Professor' },
    { value: 'organizationMember', description: 'Estudante' }
  ];
/**Usado somente para adicionar nova pessoa, como o professor só adiciona estudantes */
  userProfilesNewMember = [ 
    { value: 'organizationMember', description: 'Estudante' }
  ];
