...
import { AssessmentScalesComponent } from './assessment/assessment-scale/assessment-scale.component';
...
const routes: Routes = [
  ...
  { path: 'assessment/:assessmentId/scale', component: AssessmentScalesComponent},
